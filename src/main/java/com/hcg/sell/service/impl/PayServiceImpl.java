...
import com.hcg.sell.utils.JsonUtil;
import com.hcg.sell.utils.MathUtil;
...
public class PayServiceImpl implements PayService {
    ...
    public PayResponse create(OrderDTO orderDTO) {
        ...
        log.info("【微信支付】payResult={}", JsonUtil.toJson(payRequest));

        PayResponse payResponse = bestPayService.pay(payRequest);
        log.info("【微信支付】payRespons={}",JsonUtil.toJson(payResponse));
